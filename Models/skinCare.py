...
class SkinCare:
    def __init__(self, name, brand, price, safety_standard, good_availability, warranty, age_suitability, supplier, country, hypoallergenic, bottle_size_in_ml, skin_care_type):
